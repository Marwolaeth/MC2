...
#| label: fig-pop-graph
#| fig-cap: "US population since 1790. Left: linear axes. Right: semi-log axes"
...
```{r echo=FALSE, fig.margin=TRUE}
#| label: fig-pop-graph-log
#| fig-cap: "Population since 1790."
...
#| fig-cap: "Annual per capita growth rate of the US population (percent)"
#| fig-cap-location: margin
...
`r insert_exercises("Accumulation", "intro")`
