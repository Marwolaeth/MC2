...
For use in calculus, it is helpful to re-write the Ideal Gas Law in functional form. There are several ways to do this. For instance, if we wanted to measure the number of moles of gas in a container, we could use the function $n(P, V, T) = PV/RT$. Here, we will focus on pressure as a function of the other quantities:
$$P(n, V, T) = nRT/V.$$
...
slice_plot(myP(V, T=300) ~ V, color = "dodgerblue", bounds(V = c(1, 10)), label_text = "300 K") %>%
