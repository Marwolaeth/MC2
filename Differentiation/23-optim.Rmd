...
#| fig-cap: "Zooming in on the argmax of the objective function. It is important to look at the scale of the vertical axis. Any value of $\\theta$ between about 40 and 50 gives a close approximation to the maximum."
#| column: margin
slice_plot(f(theta) ~ theta, bounds(theta = c(40, 50))) %>%
...
#| label: fig-d2-hill
#| column: page-right
#| fig-cap: "Top row: An objective function near an argmax (left) and an argmin (right). Bottom row: The derivative of the objective function. A horizontal line (orange) marks zero on the vertical axis."
