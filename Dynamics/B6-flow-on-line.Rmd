...
```{r echo=FALSE}
#| label: fig-phase-line-intro
#| fig-cap: "A one-dimensional state space shown with its flow vectors."
#| fig-cap-location: margin
# raw <- rfun( ~ x, seed=920)
# Znotes::phase_line(raw(x) - 2 ~ x, bounds(x=-4:4),
#                    nix_dyn=TRUE, narrows=25,
#                    transform=function(x) x^.75) 
knitr::include_graphics("www/phase-line.png")
```
...
```{r echo=FALSE}
#| label: fig-phase-line-intro3
#| fig-cap: "Zooming in on the flow for the system shown in \\@fig-phase-line-intro2."
#| fig-cap-location: margin
raw <- rfun( ~ x, seed=920)
...
```{r echo=FALSE}
#| label: fig-phase-line-zoom1
#| fig-cap: "Zooming in closely on each of the fixed points seen in \\@fig-phase-line-intro3."
raw <- rfun( ~ x, seed=920)
pA <- Znotes::phase_line(raw(x) - 2 ~ x, bounds(x=-3.07:-3.05), 
                   nix_dyn=FALSE, 
                   narrows=15, 
                   transform=function(x) x^1.03) 
pB <- Znotes::phase_line(raw(x) - 2 ~ x, bounds(x=-1.59:-1.58), 
                   nix_dyn=FALSE, 
                   narrows=15, 
                   transform=function(x) x^1.03) 
...
```{r echo=FALSE}
knitr::include_graphics("www/Stability-Animation.png")
```

A stand-alone, interactive version of this diagram is available at <../www/Stability-Animation.html>.
:::
...
#| label: fig-phase-line-random
#| fig-cap: "The dynamical function shown in black is a distortion of $f(x)$ from the previous plots. Yet the flow field is practically identical and leads to the same outcomes as $f(x)$ for any initial condition."
#| fig-cap-location: margin
...
Let's return to the model of saving for retirement in Chapter @sec-chap-diff-eq-intro:
$$\partial_t V = r\, V + M\ .$$
...
#| label: fig-grazing-comparison
#| fig-cap: "Comparing the pasture dynamics for different herd sizes." #| fig-cap-location: margin
r = .3; K=10; C=0.1; H=3
...
```{r}
#| label: fig-cow-consumption
#| fig-cap: "Consumption of vegetation by a single cow as a function of the amount available in the pasture."
#| fig-cap-location: margin
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
#| label: fig-grazing-comparison2
#| fig-cap: "Pasture dynamics for a sigmoid consumption function."
#| fig-cap-location: margin
