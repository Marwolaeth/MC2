...
Representing air resistence by the function $r(u, v)  \equiv \alpha \sqrt{\strut u^2 + v^2}$, the dynamics are 
\begin{eqnarray}
\partial_t x & = u\\
\partial_t y & = v\\
\partial_t u & = -u\ r(u,v)\\
...
```{r cannon-shot-2, echo=FALSE, warning=FALSE}
#| label: fig-cannon-shot-2
#| fig-cap: "Adding air resistence to the model changes the trajectory. For reference, the trajectory *without air resistence* is plotted in $\\color{orange}{\\text{orange}}$."
P1 <- 
  gf_hline(yintercept=~0, color="brown") %>%
...
$$\partial_{tt}\ y + 2\, \partial_t\, y - 3\, y = 0\ .$$ Is this system stable?
